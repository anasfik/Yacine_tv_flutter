...
6. Run the project in the browser (Google Chrome or Microsoft Edge) and wait until it compile, alternatively run the command `flutter run --web-browser` from the folder path.

7. wait until the Admin Panel runs.
